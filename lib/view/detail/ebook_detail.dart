...
class _EbookDetailState extends State<EbookDetail> {
                          ...
                          adsMode == "1"
                              ...
                              : adsMode == "2"
                                  ? UnityBannerAd(
                                      ...
                                      listener: (state, arg) {
                                        print(
                                            "testLoadUnityAds $state and $arg");
                                      },
                                    )
                                  : Container(),
                          SizedBox(
  ...
  void _loadRewardedAd(String admobInterstitial) {
    RewardedAd.load(
      adUnitId:
          AdManager().rewardedAdUnitId(admobInterstitial, admobInterstitial),
      request: AdRequest(),
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: Text(
                    'If you skip Ad you cant open chapter'), //Text('The Ad not available yet at this moment, please try again later'),
                actions: [
                  TextButton(
                    child: Text(
                      'cancel'.toUpperCase(),
