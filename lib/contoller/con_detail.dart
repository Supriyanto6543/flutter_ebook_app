...
Future<List<ModelEbook>> fetchDetail(List<ModelEbook> latest, int id) async{
  var response = await Dio().get(ApiConstant().baseUrl+ApiConstant().api+ApiConstant().detail+id.toString(), options: Options(
