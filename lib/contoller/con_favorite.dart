...
Future<List<ModelEbook>> fetchFavorite(List<ModelEbook> latest, String id) async{
  var response = await Dio().get(ApiConstant().baseUrl+ApiConstant().api+ApiConstant().favorite+id, options: Options(
